...
class Population {
  ...
  void setBestPlayer() {
    ...
    // se melhor esta gen é melhor que a melhor pontuação global então defina o melhor global como o melhor deste gen
  ...
  Player selectPlayer() {
    ...
    // depois passe por todos os jogadores e adicione sua adequação a uma soma corrente e se essa soma for maior que o valor aleatório gerado pelo jogador escolhido
  ...
  //Calculo da taxa de refinamento dos players
