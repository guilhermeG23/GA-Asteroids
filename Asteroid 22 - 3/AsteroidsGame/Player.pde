...
class Player {
  ...
  //impede o jogador de fotografar muito rapidamente
  int shootCount = 0;
  ...
  // se o jogador está sendo jogado
  ...
  Player() {
    ...
    asteroids.add(new Asteroid(random(width), 0, random(-1, 1), random(-1, 1), int(random(1, 4)))); 
    asteroids.add(new Asteroid(random(width), 610, random(-1, 1), random(-1, 1), int(random(1, 4))));   
    asteroids.add(new Asteroid(0, random(height), random(-1, 1), random(-1, 1), int(random(1, 4))));
    asteroids.add(new Asteroid(1160, random(height), random(-1, 1), random(-1, 1), int(random(1, 4))));
    asteroids.add(new Asteroid(random(width), random(height), random(-1, 1), random(-1, 1), int(random(1, 4))));
    ...
    asteroids.add(new Asteroid(randX, randY, pos.x- randX, pos.y - randY, int(random(1, 4))));
    asteroids.add(new Asteroid(randX, randY, pos.x- randX, pos.y - randY, int(random(1, 4))));
  ...
  //sem impulso
  void boostOff() {
    //Chamada para retirar a impiulsao
    acc.setMag(0);
  }
  //------------------------------------------------------------------------------------------------------------------------------------------
  //spin that player
  ...
  void show() {
    ...
    if (!dead) {
      ...
      //Nao ha a necessidade de diminuir i immortalCount se ele ja e 0
      if (immortalCount >0) {
        immortalCount --;
      }
  ...
  void update() {
    ...
    // se algum marcador expirar, remova-o
    for (int i = 0; i < bullets.size(); i++) {
  ...
  void resetPositions() {
    ...
    rotation = 0; //Zerando a toram para comeccarem igauis
  }
  //------------------------------------------------------------------------------------------------------------------------------------------
  ...
  //Mutacao
  void mutate() {
    //Mutaca puxando a rede Neural
    brain.mutate(globalMutationRate);
  }
  //---------------------------------------------------------------------------------------------------------------------------------------------------------  
  //returns a clone of this player with the same brian
  // retorna um clone deste jogador com o mesmo brian
  Player clone() {
    //Novo player = clone
  ...
  // retorna um clone deste jogador com o mesmo brian e as mesmas sementes aleatórias usadas para que todos os asteróides estejam nas mesmas posições
  Player cloneForReplay() {
    //Clonando o player atua cim semente
